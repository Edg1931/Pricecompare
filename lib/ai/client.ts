...
// defaults to a stronger model than vision/listing. Opus 4.8 — this API
// account doesn't have Opus 5 access (calls failed in production). Override
// with RESEARCH_MODEL to trade accuracy for cost.
